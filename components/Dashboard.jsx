        ...
        if (window.ethereum && window.ethereum.selectedAddress) {
          ...
          const contractABI = [
            ...
            },
            {
              ...
              outputs: [
                {
                  internalType: "contract ParsDividendTracker",
                  name: "",
                  type: "address",
                },
              ],
            ...
            {
              inputs: [
                { internalType: "uint256", name: "GWEI", type: "uint256" },
              ],
            ...
            },
            {
              ...
              name: "setMinimumTokenBalanceForAutoDividends",
              outputs: [],
              stateMutability: "nonpayable",
              type: "function",
            },
            ...
            {
              inputs: [
                { internalType: "uint256", name: "deadBuy", type: "uint256" },
                { internalType: "uint256", name: "deadSell", type: "uint256" },
                {
                  internalType: "uint256",
                  name: "marketingBuy",
                  type: "uint256",
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress=0x593649f70f836565e33f0bce9af9503c243359b3&apikey=RK9BKPUGPM4MIXZBXK4QWTYCW3YRN3WGKF"
        );
        const data = await response.json();
        const totalSupplyValue =
          data.result && !isNaN(data.result) ? Number(data.result) : 0;
  ...
  return (
    <div className="w-full flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4 w-full">
        <h2 className="text-lg font-medium text-gray-400">Supply Overview</h2>
        <div className="grid lg:grid-cols-2 gap-4 w-full">
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4">
            ...
            <p className="text-xs text-[#14c2a3] font-medium">BSC Network</p>
          </div>
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4">
            <div className="flex items-center justify-between w-full">
            ...
            <p className="text-xs text-[#14c2a3] font-medium">Locked Supply</p>
          </div>
        </div>
      </div>
      {/* our token */}
      <div className="flex flex-col gap-4 w-full">
        <h2 className="text-lg font-medium text-gray-400">Token Metrics</h2>
        <div className="grid lg:grid-cols-3 gap-4 w-full">
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4 items-center justify-center min-h-[180px]">
            <p className="text-sm font-medium text-gray-400">Token Price</p>
            {tokenPrice !== null ? (
              <p className="text-3xl font-semibold text-[#14c2a3]">
                ${tokenPrice}
              </p>
            ) : (
              <Image
                className="object-cover w-8 h-8 opacity-50"
                alt="loading"
                src={thunderBolt}
              />
            )}
          ...
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4 items-center justify-center min-h-[180px]">
            ...
            <p className="text-xs text-gray-500 mb-2">(48 hours cooldown)</p>
            {showClaimButton && <Claim />}
            {!showClaimButton && (
              <p className="text-xs text-gray-500">Waiting for cooldown</p>
            )}
          </div>
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4 items-center justify-center min-h-[180px]">
            <p className="text-sm font-medium text-gray-400">
          ...
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4 items-center justify-center min-h-[180px]">
            <p className="text-sm font-medium text-gray-400">Next Payout</p>
          ...
          <div className="rounded-xl bg-[#111111] border border-[#1a1a1a] px-6 py-6 flex flex-col gap-4 items-center justify-center min-h-[180px]">
            <p className="text-sm font-medium text-gray-400">Total Rewards</p>
